...
const DATA_VERSION = "20260509-uae-27";
...
function makePagesDeploymentAudit() {
  ...
  const checks = [
    { ok: DATA_VERSION === "20260509-uae-27" },
    { ok: dataOk },
    { ok: styleOk },
    { ok: runtimeOk },
    { ok: liveUrlOk },
  ...
  const cards = [
    {
      ...
      status: DATA_VERSION === "20260509-uae-27" ? "current" : "stale",
      className: DATA_VERSION === "20260509-uae-27" ? "is-good" : "is-warning"
    },
    {
      label: "Data packs",
    ...
    },
    {
      ...
      detail: "Decision Journal, Pilot Sessions, Pilot Follow-Ups, Pilot Outreach, Pilot Conversion, Launch Control, and the core desk functions are available.",
  ...
  const checklist = [
    "Extract the v27 ZIP and upload the contents to the GitHub repo root, not the wrapper folder.",
    ...
    "Open Pages Doctor and confirm version 20260509-uae-27, data packs loaded, style fallback embedded, and runtime booted.",
    "Run one sample question, then open Brief Workbench, Readiness Gate, Decision Journal, Pilot Sessions, Pilot Follow-Up Board, Pilot Outreach Composer, Pilot Conversion Pipeline, and Launch Control."
  ];
