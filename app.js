...
const DATA_VERSION = "20260509-uae-11";
...
function showDataLoadError(error) {
  ...
  const message = window.location.protocol === "file:"
    ? "MajlisAlpha v11 loads its data from JSON files. Open it through GitHub Pages or a local web server so the browser can fetch the data folder."
